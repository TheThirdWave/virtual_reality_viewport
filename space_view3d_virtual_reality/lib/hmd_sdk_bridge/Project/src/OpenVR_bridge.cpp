...
OpenVRImpl::~OpenVRImpl()
{
	...
	delete m_hmdPosition; // --@thethirdwave note: it looks like you're doing the right thing here, if there's a new, there should be a delete. (though some libraries can make things weird)
