...
void OculusImpl::getControllerState(long* c_state1, float* c_pos1, long* c_state2, float* c_pos2) {}
...
void Oculus::getControllerState(long* c_state1, float* c_pos1, long* c_state2, float* c_pos2)
{
