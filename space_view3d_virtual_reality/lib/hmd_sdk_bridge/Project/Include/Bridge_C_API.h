...
EXPORT_LIB void HMD_getControllerState(HMD *hmd, uint64_t *c_state1, float *c_pos1, uint64_t *c_state2, float *c_pos2) { hmd->getControllerState(c_state1, c_pos1, c_state2, c_pos2); }
